...
public enum FaultNames {
	PIN_SMALL("Small Pin", 0), PIN_BIG("Big Pin", 1), CHANNEL_ONE("Channel E", 2), CHANNEL_TWO("Channel Three",
			3), CHANNEL_THREE("Channel Tree", 4), CONNECTOR_A("Connector A", 5), CONNECTOR_B("Connector B",
					6), CONNECTOR_C("Connector C", 7), FUSE_E("Fuse E", 8), FUSE_THREE("Fuse Three", 9), FUSE_TREE(
							"Fuse Tree",
							10), DEADWIRE("Dead Wire", 11), HOTWIRE("Hot Wire", 12), NOFAULT("No Fault", 13);
